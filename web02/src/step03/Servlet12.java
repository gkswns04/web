...
/*
# HTTP request 프로토콜
GET /web02/step03/servlet12?name=aaaa&age=30&tel=111-1111 HTTP/1.1 (CRLF)
Host: 192.168.0.30:8080 (CRLF)
Connection: keep-alive (CRLF)
Cache-Control: max-age=0 (CRLF)
Accept: text/html,application/xhtml+xml,application/xml;q=0.9, ... (CRLF)
Upgrade-Insecure-Requests: 1 (CRLF)
User-Agent: Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 ... (CRLF)
